    ...
    <div className={`mt-4 ${className}`}>
      <button
        ...
        className={`flex items-center w-full text-xs font-semibold tracking-wider ${
          isSidebarClosed ? "justify-center px-2" : "justify-between px-4"
        } py-2 ${isDark ? "text-neutral-400" : "text-gray-500"} ${
      ...
      >
        ...
        {showChevron && (
          <div
            className={
              isSidebarClosed ? "flex items-center justify-center w-8 h-8" : ""
            }
          >
            {isOpen ? (
